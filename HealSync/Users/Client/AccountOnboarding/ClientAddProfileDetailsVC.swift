//
//  addProfileDetailsVC.swift
//  HealSync
//
//  Created by Arfa on 15/01/2026.
//

import UIKit

class ClientAddProfileDetailsVC: BaseViewController {
